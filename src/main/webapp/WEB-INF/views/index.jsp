...
<div id="carouselExampleDark" class="carousel carousel-dark slide imgdiv" data-bs-ride="carousel" style="height: 700px">
	...
	<div class="carousel-inner">
		<div class="carousel-item active" data-bs-interval="2000">
			<img src="${root}resources/img/studyimg1.jpg" class="d-block w-100">
		...
		<div class="carousel-item" data-bs-interval="2000">
			<img src="${root}resources/img/studyimg2.jpg" class="d-block w-100" alt="...">
			<div class="carousel-caption d-none d-md-block">
		...
		<div class="carousel-item">
			<img src="${root}resources/img/studyimg3.jpg" class="d-block w-100" alt="...">
			<div class="carousel-caption d-none d-md-block">
