  ...
  <div class="container text-center">
    <div class="row">
      ...
      <div class="col-lg-4 mb-5 mb-lg-0">
        <p class="team">1조<br>(Click for Move to Git Repository)</p>
        <p class="lead mb-0">
          <a href="https://github.com/ygs3004">윤건수,</a>
          <a href="https://github.com/Sun-mie">조선미,</a>
          <a href="https://github.com/leewsuk">이우석</a><br>
          <a href="https://github.com/MINMIMMIN">이지민,</a>
      ...
      <div class="col-lg-4 mb-5 mb-lg-0">
        ...
        <a class="btn btn-outline-light btn-social mx-1" href="https://www.google.com/"><i class="fa-brands fa-google"></i></a>
      </div>
      <!-- Footer About Text-->
      <div class="col-lg-4">
